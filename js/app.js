...
var firstAndPike = {
  ...
  totalCookies: 0,
  calcTotal: function() {
    for(var l = 0; l < this.cookiesPerHour.length; l++) {
      this.totalCookies += this.cookiesPerHour[l];
    }
  },
  render: function() {
